  ...
  return (
    <div className="pb-1">
      <label className="relative flex h-9 ">
        ...
        {...props}
        {...field} />
        <span className={classNames("absolute cursor-auto  -translate-y-1/2  left-2.5 text-gray-400 transition-all",{
      ...
      {!!meta?.error && !!meta?.touched && (<p className="text-red-500 text-xs ml-2 mt-1">{meta.error}</p>)}
    </div>
  );
};
